...
<!--==============================content=================================-->
 <script>
  ...
  <section id="content">
      ...
      <div class="main">
      	<label><h1><spring:message code="modificar_albaran_entrada" /></h1></label>
                  <br>
		<div id="listado1">
			<table>
		...
		<div id="filtro">
			...
			<form action="ModificadoAlbaranEntrada" method="POST">
				...
				<input type = "hidden" name = "n_albaran" value = "${albaranEntrada.nAlbaran}"/><!-- Por lo que sea no pilla el n_albaran y lo paso como hidden -->
				<br>
				<label for="n_socio"><spring:message code="n_socio" /></label> 
				<input type="text" id="n_socio" name="n_socio" value="${albaranEntrada.nSocio}"/>
				<br>
				<label for="fecha"><spring:message code="fecha" /></label> 
				<input type="text" id="fecha" name="fecha" value="${albaranEntrada.fechaStr}"/>
				<br>
	...
	<div id="filtro">
			...
			<form action="addAcumuladorE" method="POST">	
				...
				<label for="peso"><spring:message code="peso" /></label> 
				<input type="text" id="peso" name = "peso" />
				<br>
				
				<label for="precio_kg"><spring:message code="precio_kg" /></label> 
				<input type="text" id="precioKg" name = "precio_kg" />
