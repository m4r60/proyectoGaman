...
<!--==============================content=================================-->
   ...
   <section id="content">
      <div class="main-block">
        <div class="main">
          <div id="filtro">
              <label><h1><spring:message code="nuevo_cliente" /></h1></label>
         </div>
            <br>
			<form action="crearCliente" method="POST" >
				<label for="nombre_razon_social"><spring:message code="nombre_razon_social"/>:</label> 
				<input type="text" id="nombre_razon_social" name="nombre_razon_social" placeholder="Nombre/RazÃ³n Social"/> 
				<br /> <br /> 
				...
				<input type="text" id="cif_nif" name="cif_nif" placeholder="CIF/NIF" value = "${cifNif}"/> 
				<br /><br /> 
                ...
                <div id="filtro">
                  <!-- ***************CONTROLADORES*************** -->
                  <input type="hidden" name="nCliente" value ="${n_cliente}">
